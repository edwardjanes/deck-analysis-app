  ...
  if (recovery.action === "REQUEST_REUPLOAD") {
    return (
      <div style={panelStyle}>
        ...
        <p style={bodyStyle}>{recovery.message}</p>
        <a href="/investability-score/upload" style={btnStyle(GREEN, "#000")}>Re-upload your deck →</a>
      </div>
    );
  }
    ...
    return (
      <div style={panelStyle}>
        ...
        <div style={{ display: "flex", gap: "10px", justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <a href="/investability-score/upload" style={btnStyle("transparent", "#6B7280", "1px solid #374151")}>
            Start fresh
          </a>
        </div>
      </div>
    ...
    <main style={{
      ...
      <nav style={{ borderBottom: "1px solid #111927", padding: "0 24px", flexShrink: 0 }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", height: "64px", display: "flex", alignItems: "center" }}>
          <a href="/investability-score" style={{ display: "flex" }}>
